...
function Header() {
  return (
    <section className="bg-white-200 rounded-3xl min-h-fit flex flex-col xl:p-7 p-4 gap-2">
      <div className="flex flex-col gap-5 text-black justify-center items-center 3xl:gap-8 lg:p-6">
        <h2 className="lg:text-3xl text-xl font-[400]">
          Hello, I&apos;m Farouk
        </h2>
        <h1 className="xl:text-7xl xl:leading-[5rem] text-4xl font-[500] text-center xl:w-[90%] 2xl:w-full 3xl:w-[95%] 2xl:text-6xl 3xl:text-7xl 3xl:leading-tight lg:w-fit">
