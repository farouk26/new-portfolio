    ...
    <div className="navbar bg-white-200 rounded-full mt-8 px-6">
      <div className="navbar-start text-black flex gap-2 items-center w-full">
        <Menu as="div">
          ...
          >
            <Menu.Items className="absolute px-8 lg:left-[12%] right-0 z-10 lg:w-[22%] w-screen divide-y divide-white lg:mt-8 mt-4 origin-top-0 bg-dark-100 text-white focus:outline-none py-2 rounded-3xl">
