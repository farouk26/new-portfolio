  ...
  return (
    <section className="bg-white-200 rounded-3xl min-h-fit flex flex-col xl:p-7 p-5 xl:gap-2 md:gap-8 gap-6">
      <div className="flex flex-col xl:gap-2 gap-5 text-black justify-center items-center 3xl:gap-7 lg:p-6">
        ...
        <h1 className="xl:text-6xl xl:leading-[5rem] md:text-5xl text-4xl font-[500] text-center xl:w-[95%] 2xl:w-full 3xl:w-[80%] 2xl:text-6xl 3xl:text-7xl 3xl:leading-tight lg:w-[75%] md:w-[80%]">
          Building web wonders that inspire and captivate.
        </h1>
        <p className="text-xl md:text-2xl 3xl:text-2xl w-full md:w-[60%] lg:w-[65%] xl:w-2/3 text-center">
